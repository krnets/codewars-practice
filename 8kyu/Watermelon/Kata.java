...
It's too hot, and they can't even…
        ...
        in such a way that each of the two parts consists of an even number of watermelons.
        ...
        and find out, whether they can divide the fruits in the way they want. For sure, each of them should get a part
        of positive weight.
        Task

        Given an integral number of watermelons w (1 ≤ w ≤ 100; 1 ≤ w in Haskell), check whether Pete and Billy can
...
public class Kata {
    public static boolean divide(int weight) {
        return weight > 2 ? (weight / 2) * 2 == weight : false;
    }
}
*/
public class Kata {
