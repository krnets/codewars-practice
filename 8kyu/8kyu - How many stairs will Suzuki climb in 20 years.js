...
//     let oneYearTotal = s.map(v => v.reduce((a, b) => a + b, 0)).reduce((a, b) => a + b, 0)
//     return oneYearTotal * 20
// }

// const stairsIn20 = (s) => 20 * s.reduce((total, c) => total + c.reduce((acc, n) => acc + n, 0), 0)

function stairsIn20(s) {
    for (var sum = 0, i = 0; i < s.length; i++) {
