...
from kata import is_age_diverse
...
def test_group():
    ...
    def test_case():
        ...
        test.assert_equals(is_age_diverse(list1), True)
        test.assert_equals(is_age_diverse(list2), False)
        test.assert_equals(is_age_diverse(list3), False)