...
public class AreSame {
    public static boolean comp(int[] a, int[] b) {
        return b != null && Arrays.equals(IntStream.of(a).map(x -> x * x).sorted().toArray(),
                                          IntStream.of(b).sorted().toArray());
    }
}
...
public class AreSame {
    public static boolean comp(int[] a, int[] b) {
        return a != null && b != null && Arrays.equals(of(a).map(x -> x * x).sorted().toArray(), of(b).sorted().toArray());
    }
}
*/
/*
public class AreSame {
    public static boolean comp(int[] a, int[] b) {
        return a != null && b != null && of(a).map(Math::abs).sum() == of(b).mapToDouble(Math::sqrt).sum();
    }
}
*/
