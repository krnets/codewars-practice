...
def sum_consecutives(s):
    return [sum(g) for k, g in groupby(s)]


q = sum_consecutives([1, 4, 4, 4, 0, 4, 3, 3, 1])
q
#      [1,12,0,4,6,1], "on list [1,4,4,0,4,3,3,1] you get "
q = sum_consecutives([1, 1, 7, 7, 3])
q
#      [2,14,3], "on list [1,1,7,7,3] you get "
q = sum_consecutives([-5, -5, 7, 7, 12, 0])
q
#      [-10,14,12,0], "on list [-5,-5,7,7,12,0] you get "
q = sum_consecutives([3, 3, 3, 3, 1])
q
