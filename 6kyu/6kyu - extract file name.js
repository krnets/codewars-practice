...
class FileNameExtractor {
    static extractFileName(dirtyFileName) {
        ...
        // return dirtyFileName.match(/(\d+_)([^.]+.[^.]+)(.+)/)[2]
        // return dirtyFileName.match(/^\d+_([^.]+\.[^.]+)/)[1]
        // return dirtyFileName.replace(/^\d*_(.*)\..*$/,'$1')
        // return dirtyFileName.match(/_([^.]+\.[^.]+)/)[1]
        return /\_(.*)\./.exec(dirtyFileName)[1]
    }
}

q = FileNameExtractor.extractFileName("1_FILE_NAME.EXTENSION.OTHEREXTENSIONadasdassdassds34")
// "FILE_NAME.EXTENSION"
q

q = FileNameExtractor.extractFileName("1231231223123131_FILE_NAME.EXTENSION.OTHEREXTENSION")
// "FILE_NAME.EXTENSION"
q