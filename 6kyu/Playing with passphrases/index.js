...
const playPass = (s, n) => [...s.replace(/\d/g, v => 9 - v).replace(/[A-Z]/g, c => String.fromCodePoint((c.charCodeAt() + n + 65) % 26 + 65))].map((v, i) => i % 2 ? v.toLowerCase() : v).reverse().join('')


q = playPass("I LOVE YOU!!!", 1)
// "!!!vPz fWpM J"
q
q = playPass("MY GRANMA CAME FROM NY ON THE 23RD OF APRIL 2015", 2)
