...
const isTriangleNumber = number => Math.sqrt(number * 8 + 1) % 1 == 0

q = isTriangleNumber(3) // true, "Expected true for input 3.  Got " + isTriangleNumber(3) + "."
q
q = isTriangleNumber(5) // false, "Expected false for input 5.  Got " + isTriangleNumber(5) + "."
q
q = isTriangleNumber("hello!") // false, "Expected false for input 'hello!'.  Got " + isTriangleNumber("hello!") + "."
q
q = isTriangleNumber(6.15) // false, "Expected false for input 6.15.  Got " + isTriangleNumber(6.15) + "."
q