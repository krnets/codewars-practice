...
#         if n == sum(int(x) ** (i+1) for i, x in enumerate(str(n))):
#             res.append(n)
#     return res

def sum_dig_pow(a, b):
    return [x for x in range(a, b+1) if x == sum(int(v) ** (i+1) for i, v in enumerate(str(x)))]


q = sum_dig_pow(1, 10)  # [1, 2, 3, 4, 5, 6, 7, 8, 9]
q
q = sum_dig_pow(1, 100)  # [1, 2, 3, 4, 5, 6, 7, 8, 9, 89]
q
q = sum_dig_pow(10, 89)  # [89]
q
q = sum_dig_pow(10, 100)  # [89]
q
q = sum_dig_pow(90, 100)  # []
q
q = sum_dig_pow(89, 135)  # [89, 135]
q
