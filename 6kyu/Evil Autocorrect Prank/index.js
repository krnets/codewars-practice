...
Algorithms | Strings | Regular Expressions | Declarative Programming | Advanced Language Features | Fundamentals | Functions | Control Flow | Basic Language Features */

const autocorrect = (input) => input.replace(/\b(you+|u)\b/gi, 'your sister')

q = autocorrect('test you')
q
q = autocorrect('test u')
q
q = autocorrect('test youuuuuuuu')
q