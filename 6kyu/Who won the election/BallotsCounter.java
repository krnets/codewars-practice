...
public class BallotsCounter {
    public static String getWinner(final List<String> listOfBallots) {
        return listOfBallots.stream().distinct()
                .filter(ballot -> Collections.frequency(listOfBallots, ballot) > listOfBallots.size() / 2)
...
public class BallotsCounter {
    public static String getWinner(final List<String> listOfBallots) {
        int majority = listOfBallots.size() / 2 + 1;
        var unique = new HashSet<>(listOfBallots);

        for (String ballot : unique) {
...
public class BallotsCounter {
    public static String getWinner(final List<String> listOfBallots) {
        ...
        var groups = listOfBallots.stream()
