...
//     const twist = n => String(n).replace(/[37]/g, v => ({7:3, 3:7})[v])
//     return array.slice().sort((a, b) => twist(a) - twist(b))
// }

function sortTwisted37(array) {
    const twist = n => String(n).replace(/3|7/g, v => v == 3 ? 7 : 3)
    return array.slice().sort((a, b) => twist(a) - twist(b))
}

q = sortTwisted37([1, 2, 3, 4, 5, 6, 7, 8, 9]) // [1,2,7,4,5,6,3,8,9]
q
q = sortTwisted37([12, 13, 14]) // [12,14,13]
q
q = sortTwisted37([9, 2, 4, 7, 3]) // [2,7,4,3,9]
q