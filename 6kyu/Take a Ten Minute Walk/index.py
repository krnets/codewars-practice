...
def is_valid_walk(walk):
    if len(walk) is not 10: return False
...
q = is_valid_walk(['n', 's', 'n', 's', 'n', 's', 'n', 's', 'n', 's'])  # True
q
q = is_valid_walk(['w', 'e', 'w', 'e', 'w', 'e', 'w', 'e', 'w', 'e', 'w', 'e'])  # False
q
q = is_valid_walk(['w'])  # False
q
q = is_valid_walk(['n', 'n', 'n', 's', 'n', 's', 'n', 's', 'n', 's'])  # False
q
