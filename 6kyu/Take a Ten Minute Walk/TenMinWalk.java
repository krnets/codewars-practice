...
public class TenMinWalk {
    public static boolean isValid(char[] walk) {
        ...
        return counter.getOrDefault('n', 0).equals(counter.getOrDefault('s', 0)) &&
                counter.getOrDefault('w', 0).equals(counter.getOrDefault('e', 0)) &&
                walk.length == 10;
    }
}*/
...
public class TenMinWalk {
    public static boolean isValid(char[] walk) {
        ...
        for (char c : walk) {
            switch (c) {
                case 'n': point.translate(0,1); break;
                case 'e': point.translate(1,0); break;
                case 's': point.translate(0, -1); break;
                case 'w': point.translate(-1, 0); break;
            }
        }
