...
public class IQTests
{
    ...
    public void Test3()
    {
        Assert.AreEqual(4, IQ.Test("88 96 66 51 14 88 2 92 18 72 18 88 20 30 4 82 90 100 24 46"));
    }

    [Test]
    public void Test4()
    {
        Assert.AreEqual(2, IQ.Test("100 99 100"));
    }

    [Test]
    public void Test5()
    {
        Assert.AreEqual(3, IQ.Test("5 3 2"));
    }

    [Test]
    public void Test6()
    {
        Assert.AreEqual(2, IQ.Test("43 28 1 91"));
    }
    ...
    {
        Assert.AreEqual(26,
            IQ.Test("20 94 56 50 10 98 52 32 14 22 24 60 4 8 98 46 34 68 82 82 98 90 50 20 78 49 52 94 64 36"));
    }
    ...
    public void Test9()
    {
        Assert.AreEqual(3, IQ.Test("100 100 1"));
    }
