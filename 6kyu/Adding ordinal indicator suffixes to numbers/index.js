// 6kyu - Adding ordinal indicator suffixes to numbers

/* Finish the function numberToOrdinal, which should take a number and return it as a string with 
...
//     return n ? n + suffixes[n % 100 > 10 && n % 100 < 20 ? 0 : Math.min(n % 10, 4)] : "0"
// }

// const numberToOrdinal = n => n ? n + ['th','st','nd','rd','th'][n % 100 > 10 && n % 100 < 20 ? 0 : Math.min(n % 10, 4)] : '0'

const numberToOrdinal = n => n ? n + ['th','st','nd','rd','th'][n % 100 > 10 && n % 100 < 20 ? 0 : Math.min(n % 10, 4)] : '0'

q = numberToOrdinal(1) // '1st'
q
q = numberToOrdinal(2) // '2nd'
q
q = numberToOrdinal(3) // '3rd'
q
q = numberToOrdinal(4) // '4th'
q