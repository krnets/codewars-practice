...
Unfortunately, not all of the houses have numbers written on them, and on top of that the boy is 
...
q = houseNumbersSum([5, 1, 2, 3, 0, 1, 5, 0, 2]) // 11
q
q = houseNumbersSum([4, 2, 1, 6, 0]) // 13
q
q = houseNumbersSum([4, 1, 2, 3, 0, 10, 2]) // 10
q
q = houseNumbersSum([0, 1, 2, 3, 4, 5]) // 0
q