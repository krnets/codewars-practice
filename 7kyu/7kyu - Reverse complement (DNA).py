...
Note: You need to take care of lower and upper case. 
And if a sequence conatains some invalid characters you need to return "Invalid sequence".
...
def reverse_complement(dna):
    if re.match(r'[^ACGT]', dna):
        return 'Invalid sequence'
    return dna.translate(str.maketrans("ACGT", "TGCA"))[::-1]


q = reverse_complement("TTCCGGAA")  # "TTCCGGAA"
q
q = reverse_complement("GACTGACTGTA")  # "TACAGTCAGTC"
q
q = reverse_complement("")  # ""
q
q = reverse_complement("XYZ")  # "Invalid sequence"
q
