...
class Block:
    ...
    def get_volume(self): return self.width * self.length * self.height
...
block1 = Block([2, 2, 2])
block1
q = block1.get_width()  # 2
q
q = block1.get_length()  # 2
q
q = block1.get_height()  # 2
q
q = block1.get_volume()  # 8
q
q = block1.get_surface_area()  # 24
q
