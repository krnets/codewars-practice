...
Do not use the function type Function; there is a function type for converting an arbitrary class
into a double, use that.
        ...
        (Aside: you may have noticed, the function type we should have used in Part 1 is Predicate,
        even though we used Function.)
*/
...
public class FunctionalProgramming {
    public static ToDoubleFunction<Triangle> f = triangle -> {
        triangle.setArea((triangle.base * triangle.height) / 2D);
        return triangle.getArea();
    };
}
*/
