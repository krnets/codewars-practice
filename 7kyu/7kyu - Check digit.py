...
q = check_digit(1234567, 1, 0, 1)  # True
q
q = check_digit(1234567, 0, 1, 2)  # True
q
q = check_digit(67845123654, 4, 2, 4)  # True
q
q = check_digit(6668844536485, 0, 0, 6)  # True
q
q = check_digit(9999999999, 2, 5, 1)  # False
q
