...
public class Kata {
    public static int sumTriangularNumbers(int n) {
        return n < 0 ? 0 : IntStream.rangeClosed(1, n + 1).map(i -> i * (i - 1) / 2).sum();
    }
}
*/
public class Kata {
    public static int sumTriangularNumbers(int n) {
        return n < 0 ? 0 : IntStream.rangeClosed(1, n).map(i -> i * (i + 1) / 2).sum();
    }
}
...
public class Kata {
    public static int sumTriangularNumbers(int n) {
        return n < 0 ? 0 : n * (n + 1) / 2 + sumTriangularNumbers(n - 1);
    }
}
*/
