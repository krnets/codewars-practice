...
const elevatorDistance = (array) => array.reduce((sum, v, i) => sum + (Math.abs(v - array[i + 1]) || 0), 0)

q = elevatorDistance([5, 2, 8]) // 9
q
q = elevatorDistance([1, 2, 3]) // 2
q
q = elevatorDistance([7, 1, 7, 1]) // 18
q