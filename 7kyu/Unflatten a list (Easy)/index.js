...
/* Build a method that creates new arrays that can be flattened!
You have to unflatten a list/an array.
...
//         if (flatArray[0] < 3)
//             res.push(flatArray.shift())
//         else
//             res.push(flatArray.splice(0, flatArray[0]))
//     }
//     return res
// }
...
//     let res = []
//     while (flatArray.length)
//         (flatArray[0] < 3) ? res.push(flatArray.shift()) : res.push(flatArray.splice(0, flatArray[0]))
//     return res
// }
...
input = [3, 5, 2, 1]
q = unflatten(input) //  [[3, 5, 2], 1]
q

input = [1, 4, 5, 2, 1, 2, 4, 5, 2, 6, 2, 3, 3]
q = unflatten(input) // [1, [4, 5, 2, 1], 2, [4, 5, 2, 6], 2, [3, 3]]
q