...
Your Task: Validate a given EAN-Code. Return true if the given EAN-Code is valid, otherwise false.
Assumption: You can assume the given code is syntactically valid, i.e. it only consists of numbers and it exactly 
has a length of 13 characters.

validateEAN("4003301018398") // true
validateEAN("4003301018392") // false  */

// const validateEAN = (eanCode) => [...eanCode].map((v, i) => i % 2 ? v * 3 : +v).reduce((a, b) => a + b) % 10 == 0

const validateEAN = (eanCode) => [...eanCode].reduce((a, v, i) => a + v * (i % 2 ? 3 : 1), 0) % 10 == 0

q = validateEAN("9783815820865") // true
q
q = validateEAN("9783815820864") // false
q
q = validateEAN("9783827317100") // true
q