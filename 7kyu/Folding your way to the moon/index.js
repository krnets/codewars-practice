...
Also, if somebody is giving you a negative distance, it's clearly bogus and you should yell 
at them by returning null (or whatever equivalent in your language. In Shell please return None).
...
function foldTo(distance) {
    if (distance < 0) return null
    for (var folds = 0, i = 0.0001; i < distance; i *= 2) folds++
    return folds
}

q = foldTo(384000000) // 42
q