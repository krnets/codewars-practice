...
from kata import men_from_boys
...
def fixed_tests():
    ...
    def basic_test_cases():
        ...
        test.assert_equals(
            men_from_boys([20, 33, 50, 34, 43, 46]), [20, 34, 46, 50, 43, 33]
        )
        test.assert_equals(
            men_from_boys([82, 91, 72, 76, 76, 100, 85]), [72, 76, 82, 100, 91, 85]
        )
        test.assert_equals(
            men_from_boys([2, 15, 17, 15, 2, 10, 10, 17, 1, 1]), [2, 10, 17, 15, 1]
        )
        test.assert_equals(men_from_boys([-32, -39, -35, -41]), [-32, -35, -39, -41])
        test.assert_equals(
            men_from_boys([-64, -71, -63, -66, -65]), [-66, -64, -63, -65, -71]
        )
        test.assert_equals(
            men_from_boys([-94, -99, -100, -99, -96, -99]), [-100, -96, -94, -99]
        )
        test.assert_equals(
        ...
        test.assert_equals(
            men_from_boys([82, -61, -87, -12, 21, 1]), [-12, 82, 21, 1, -61, -87]
        )
        test.assert_equals(
