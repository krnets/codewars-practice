...
def nb_year(population, percent, aug, target):
    if population >= target:
        ...
        return 1 + nb_year(population * (1 + percent / 100) + aug, percent, aug, target)


q = nb_year(1500, 5, 100, 5000)  # 15
q
q = nb_year(1500000, 2.5, 10000, 2000000)  # 10
q
q = nb_year(1500000, 0.25, 1000, 2000000)  # 94
q
