...
Given the input array, write a function that when executed as findAdmin(list1, 'JavaScript') 
...
q = findAdmin(list1, 'JavaScript') // answer1
q
q = findAdmin(list1, 'Ruby') // []
q
q = findAdmin(list1, 'Python') // []
q