...
/* Everybody loves pi, but what if pi were a square? 
Given a number of digits digits, find the smallest integer whose square is greater or equal to the sum of the squares 
...
//     return Math.ceil(Math.sqrt([...PI.slice(0, digits)].reduce((acc, v) => acc + v * v, 0)))
// }

const PI = '31415926535897932384626433832795028841971693993751058209749445923078164062862089986280348253421170679'
const squarePi = digits => Math.ceil(Math.sqrt([...PI.slice(0, digits)].reduce((acc, v) => acc + v * v, 0)))
