...
const switcher = (x) => x.map(v => v == 27 ? '!' : v == 28 ? '?' : v == 29 ? ' ' : String.fromCodePoint(26 - v + 97)).join('')

q = switcher(['24', '12', '23', '22', '4', '26', '9', '8']) // 'codewars'
q
q = switcher(['25', '7', '8', '4', '14', '23', '8', '25', '23', '29', '16', '16', '4']) // 'btswmdsbd kkw'
q
q = switcher(['4', '24']) // 'wc'
q
q = switcher([20, 24, 20, 12, 22, 27, 7, 7, 19, 29, 14, 23, 21, 17, 28, 25, 25, 8, 14, 12, 13]) // gcgoe!tth mdfj?bbsmon
q