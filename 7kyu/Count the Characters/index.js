...
// const countChar = (string, char) => (string.match(RegExp(char, 'gi')) || '').length

const countChar = (string, char) => string.split(new RegExp(char, 'i')).length - 1


q = countChar("fizzbuzz", "z") // 4
q
