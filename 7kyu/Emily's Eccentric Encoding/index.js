// 7kyu - Emily's Eccentric Encoding
...
// const decode = (str) => [...str].map(ch => ch.toUpperCase() == ch ? ch : String.fromCharCode('a'.charCodeAt() + 'z'.charCodeAt() - ch.charCodeAt())).join('')
const decode = (str) => str.replace(/[a-z]/g, ch => String.fromCharCode('a'.charCodeAt() + 'z'.charCodeAt() - ch.charCodeAt()))


var secret = "I dlfow orpv gl rmgviervd lm Mlmwzb nlimrmt!";
q = decode(secret)
//  "I would like to interview on Monday morning!";
q