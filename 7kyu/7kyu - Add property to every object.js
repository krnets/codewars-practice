...
// function addPropToEveryObjInArr(arr) {
//     return arr.map((_, i) => arr[i].usersAnswer = null)
// }

// for (key in questions)
//     questions[key].usersAnswer = null

questions.forEach(key => key.usersAnswer = null)

// q = addPropToEveryObjInArr(questions)
// q
q = questions[0].usersAnswer === null
q