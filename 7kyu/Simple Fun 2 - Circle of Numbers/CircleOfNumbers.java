...
that the distance between any two neighbouring numbers is equal
...
Example : For n = 10 and firstNumber = 2, the output should be
...
public class CircleOfNumbers {
    public static int circleOfNumbers(int n, int firstNumber) {
        double median = n * .5;
        return (int) (firstNumber > median ? firstNumber - median :
                      firstNumber < median ? firstNumber + median : 0);
    }
}*/
