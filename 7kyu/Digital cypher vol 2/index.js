...
//     let key = String(n)
//     return code.map((v, i) => String.fromCodePoint(v - key[i % key.length] + 96)).join('')
// }

const decode = (code, n) => code.map((v, i) => String.fromCodePoint(v + 96 - String(n)[i % String(n).length])).join('')


q = decode([20, 12, 18, 30, 21], 1939) // "scout"
q
q = decode([14, 10, 22, 29, 6, 27, 19, 18, 6, 12, 8], 1939) // "masterpiece"
q